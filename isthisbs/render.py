...
#: Renamed from /og/site.png with the v6 relayout — social scrapers cache by
#: image URL, so the new path is what makes them re-fetch. The old path is
#: still published as an alias.
_DEFAULT_OG_PATH = f"/og/{ogimage.SITE_CARD_NAME}"
